...
def expected_frames() -> dict[str, tuple[tuple[int, int, bool], ...]]:
    ...
    canb: list[tuple[int, int, bool]] = [
        ...
        (0x5A2, 8, False), (0x5A3, 8, False), (0x5A4, 8, False),
        (0x5A5, 8, False),
        (0x5A6, 8, False), (0x5A7, 8, False),
        (0x5A8, 8, False), (0x5A9, 8, False),
        (0x5AA, 8, False), (0x5AB, 8, False), (0x5AC, 8, False),
        (0x5AD, 8, False), (0x5AE, 8, False),
...
def expected_signals() -> dict[str, tuple[tuple[int, str, int, int, str, bool, float], ...]]:
    ...
    return {
        "Vehicle_Can1.dbc": (
            ...
            (0x187F50F4, "SlaveNotReadyActionEnabled", 20, 1, "little_endian", False, 1.0),
            (0x187F50F4, "SlaveOfflineActionEnabled", 19, 1, "little_endian", False, 1.0),
            (0x187F50F4, "CellVoltageSenseActionEnabled", 18, 1, "little_endian", False, 1.0),
            (0x187F50F4, "TemperatureSenseActionEnabled", 17, 1, "little_endian", False, 1.0),
        ...
        "Vehicle_CanB.dbc": (
            ...
            (0x71, "Band0_Integer", 0, 8, "little_endian", False, 1.0),
            (0x71, "Band0_Fraction", 8, 8, "little_endian", False, 0.01),
            (0x72, "Band0_Integer", 0, 8, "little_endian", False, 1.0),
            (0x73, "Band0_Integer", 0, 8, "little_endian", False, 1.0),
            (0x74, "Band0_Integer", 0, 8, "little_endian", False, 1.0),
            (0x74, "Band3_Fraction", 56, 8, "little_endian", False, 0.01),
